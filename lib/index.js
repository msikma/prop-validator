...
const { wrapInArray } = require('./util')
 ...
 */
const validateProps = (propTypes, propsObject, strictCheck = false, objectName = []) => {
  const results = walkProps(propTypes, propsObject, strictCheck, false, wrapInArray(objectName || []))
