...
const validateProps = (passedPropTypes, passedPropsObject, objectName = []) => {
  const [propTypes, propsObject, objectPathList] = wrapProps(passedPropTypes, passedPropsObject, objectName)
  const results = walkProps(propTypes, propsObject, objectPathList)
