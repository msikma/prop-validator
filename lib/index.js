 ...
 */
const validateProps = (passedPropTypes, passedPropsObject, strictCheck = false, objectName = []) => {
  const [propTypes, propsObject, objectPath] = wrapProps(passedPropTypes, passedPropsObject, wrapInArray(objectName || []))
  const results = walkProps(propTypes, propsObject, strictCheck, false, objectPath)
