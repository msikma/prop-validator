 ...
 */
const validatorWrapper = (validatorFunction, valueExpectedTypeObject, hasNullType, isAlwaysRequired) => {
  ...
  return isRequired => (value, key, object, state, parentInfo = {}) => {
    ...
    const valueExpectedTypeList = collectExpectedTypes(validatorExpectedTypes, parentInfo.valueExpectedTypeList, !isRequired && hasNullType)
    ...
    const valueIsValidNull = value == null && !isRequired
 ...
 */
const addValidatorProperties = (validator, validatorRequired, valueMayBeUndefined, expectedPropTypes) => {
  Object.defineProperty(validator, 'isRequired', { value: validatorRequired, enumerable: false })
  Object.defineProperty(validator, 'valueMayBeUndefined', { value: true, enumerable: false })
  ...
  Object.defineProperty(validatorRequired, 'valueMayBeUndefined', { value: valueMayBeUndefined, enumerable: false })
 ...
 */
const makeValidator = (validatorFunction, requiredType, hasNullType = true, isAlwaysRequired = false, canBeUndefined = false) => {
  const expectedTypes = wrapInArray(requiredType)
  const wrappedValidatorFunction = validatorWrapper(validatorFunction, expectedTypes, hasNullType, isAlwaysRequired)
