...
describe(`prop-validator package`, () => {
  ...
  describe(`PropTypes`, () => {
    ...
    it(`${prefix}.boolean`, () => {
      ...
      const valid6 = validateProps({ val: PropTypes.bool }, { val: undefined })
      ...
      const invalid4 = validateProps({ val: PropTypes.bool.isRequired }, { val: undefined })
      ...
      expect(valid6.results[0]).toMatchObject(validResult('val', ['boolean', 'null']))
      ...
      expect(invalid4.results[0]).toMatchObject(invalidResult('val', ['boolean'], { message: `Property 'val' should be type 'boolean', but type 'undefined' was found` }))
    })
    it(`${prefix}.function`, () => {
    ...
    it(`${prefix}.any`, () => {
      ...
      for (const validItem of valid) {
        expect(validItem).toMatchObject(validTypeCheck())
        expect(validItem.results[0]).toMatchObject(validResult('val', ['any', 'null']))
      }
